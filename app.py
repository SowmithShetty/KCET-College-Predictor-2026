...
def create_pdf(df_to_print, user_details):
    try:
        ...
        pdf.multi_cell(0, 5, txt="Disclaimer: These predictions are generated by an AI model based on historical trends (2023-25). Actual cutoffs for 2026 may vary.", align='C')
